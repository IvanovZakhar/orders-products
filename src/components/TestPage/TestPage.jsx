...
<<<<<<< HEAD
    ...
    //       if(item.art.slice(3, 12) === '10-0940-К'){
    //          return {
    //              ...item,
    //              size: '642х940х541'
    //          } 
    //       }
    //       if(item.art.slice(3, 12) === '10-1150-К'){
    //          return {
    //              ...item,
    //              size: '942х1150х641'
    //          } 
    //       }
    //       if(item.art.slice(3, 12) === '10-1040-К'){
    //          return {
    //              ...item,
    //              size: '792х1040х571'
    //          } 
    //       }
    //       if(item.art.slice(3, 12) === '10-1300-К'){
    //          return {
    //              ...item,
    //              size: '1065х1300х728'
    //          } 
    ...
    //       if(item.art.slice(6, 10) === '0940'){
    //          return {
    //              ...item,
    //              size: '642х940х541'
    //          } 
    //       }
    //       if(item.art.slice(6, 10) === '1150'){
    //          return {
    //              ...item,
    //              size: '942х1150х641'
    //          } 
    //       }
    //       if(item.art.slice(6, 10) === '1040'){
    //          return {
    //              ...item,
    //              size: '792х1040х571'
    //          } 
    //       }
    //       if(item.art.slice(6, 10) === '1300'){
    //          return {
    //              ...item,
    //              size: '1065х1300х728'
    //          } 
